...
namespace Nadlan.MockData
{
    public class MockIssues
    {
        ...
        //    messages.Add(new Message { Id = 1, Content = "tests", DateStamp = DateTime.Today });
        ...
        //    List<Message> messages = new List<Message>()
        //    {
        //        new Message { Id = 1, IssueId=-10, Content = "I solved the issue", UserName = "stella" }  ,
        //        new Message { Id = 2, IssueId = -10, Content = "Ok great thanks", UserName = "yuval" }  ,

        //        new Message { Id = 3, IssueId = -9, Content = "Should I do that?", UserName = "stella" } ,
        //        new Message { Id = 4, IssueId = -9, Content = "Yes, you can do that, but don't do that and that and that, thanks.", UserName = "yuval" } ,
        //        new Message { Id = 5, IssueId = -9, Content = "Ok no problem, Ill do that!",UserName = "stella" } ,
        //        new Message { Id = 6, IssueId = -9, Content = "Great thanks :)", UserName = "yuval" } ,

        //        new Message { Id = 7, IssueId = -8, Content = "I talked to him and he said that blablbllaalala", UserName = "stella" } ,
        //        new Message { Id = 8, IssueId = -8, Content = "Thanks for the update", UserName = "yuval" } ,

        //        new Message { Id = 9, IssueId = 4, Content = "Any progress?",UserName = "yuval" },
